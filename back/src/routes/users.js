  ...
  try {
    ...
    const mailOptions = {
      ...
      html: `<p>Cliquez sur le lien pour définir votre mot de passe. : </p>
             <a href="http://31.207.39.77/create-account?token=${token}">Créer Votre Compte</a>`,
    };
  ...
  try {
    ...
    const mailOptions = {
      ...
      html: `<p>Cliquez sur le lien pour réinitialiser votre mot de passe : </p>
             <a href="http://31.207.39.77/reset-password?token=${token}">Réinitialiser votre mot de passe</a>`,
    };
